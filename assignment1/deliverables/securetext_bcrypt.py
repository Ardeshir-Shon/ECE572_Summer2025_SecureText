...
SecureText Console Messenger (Slow-Hashing + Salt Migration Version)
A basic console-based messenger application with intentional security vulnerabilities,
now updated to store passwords using bcrypt and to migrate any existing plaintext passwords.
"""
...
class SecureTextServer:
    ...
    def save_users(self):
        """Save users to JSON file with bcrypt-hashed passwords."""
        try:
...
class SecureTextClient:
    ...
    def run(self):
        ...
        print("=== SecureText Messenger (Slow-Hashing + Salt Migration Version) ===")
