...
SecureText Console Messenger (SHA-256 Password Hashing Version)
A basic console-based messenger application with intentional security vulnerabilities,
now updated to hash passwords with SHA-256 at rest.
"""
...
class SecureTextClient:
    ...
    def run(self):
        ...
        print("=== SecureText Messenger (SHA-256 Version) ===")
